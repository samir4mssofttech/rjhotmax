<x-filament-panels::page>
    {{-- Loading Indicator --}}
    <div wire:loading.delay.long class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/30 backdrop-blur-sm">
                ...
                <table class="w-full table-auto divide-y divide-gray-200 dark:divide-white/5">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-white/5">
                        ...
                        @foreach($attendances as $employeeId => $attendance)
                            <tr class="transition duration-75 hover:bg-gray-50/50 dark:hover:bg-white/[0.02] {{ $attendance['has_record'] ? '' : '' }}"
                                ...
                                <td class="px-4 py-3">
                                    <input
                                        type="text"
                                        wire:model="attendances.{{ $employeeId }}.remarks"
            ...
            <div class="border-t border-gray-100 px-6 py-4 dark:border-white/5">
                <div class="flex items-center justify-between">
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        <span class="font-medium text-gray-700 dark:text-gray-300">{{ count($attendances) }}</span> employees
                        · {{ \Carbon\Carbon::parse($date)->format('d M Y') }}
                    </p>
                    <div class="flex gap-3">
                        <a
                            href="{{ \App\Filament\Admin\Resources\Branches\BranchResource::getUrl('index') }}"
    ...
    @else
        ...
        <div class="rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
            <div class="flex flex-col items-center justify-center px-6 py-16">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">There are no active employees assigned to this branch.</p>
                <a
                    href="{{ \App\Filament\Admin\Resources\Branches\BranchResource::getUrl('index') }}"
